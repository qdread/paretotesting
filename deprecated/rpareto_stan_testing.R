...
mod <- cmdstan_model('~/R/pareto_bygrp_newpriors_noLL.stan')
...
fit$save_object('~/R/paretofit1_newpriors.rds')
...
mod2 <- cmdstan_model('~/R/pareto2_bygrp_newpriors_noLL.stan')
...
fit2$save_object('~/R/paretofit2.rds')

summ2 <- fit2$summary(variables = c('alpha_low_mean', 'alpha_low_fg', 'sigma_alpha_low', 'alpha_high_mean', 'alpha_high_fg', 'sigma_alpha_high', 'tau_mean', 'tau_fg', 'sigma_tau'))
...
mod3 <- cmdstan_model('~/R/pareto3_bygrp_newpriors_noLL.stan')
...
fit3$save_object('~/R/paretofit3.rds')

summ3 <- fit3$summary(variables = c('alpha_low_mean', 'alpha_low_fg', 'alpha_mid_mean', 'alpha_mid_fg', 'sigma_alpha_low', 'sigma_alpha_mid', 'alpha_high_mean', 'alpha_high_fg', 'sigma_alpha_high', 'tau_low_mean', 'tau_low_fg', 'sigma_tau_low', 'tau_high_mean', 'tau_high_fg', 'sigma_tau_high'))
