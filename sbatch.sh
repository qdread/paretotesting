...
sbatch --job-name=dens2all --partition=long --time=21-00:00:00 --export=s=density_stanfits_alldata.R,mod=2 job.sh
sbatch --job-name=dens3all --partition=long --time=21-00:00:00 --export=s=density_stanfits_alldata.R,mod=3 job.sh
sbatch --job-name=prod1all --export=s=prod_stanfits_alldata.R,mod=1 job.sh
sbatch --job-name=prod2all --partition=long --time=21-00:00:00 --export=s=prod_stanfits_alldata.R,mod=2 job.sh